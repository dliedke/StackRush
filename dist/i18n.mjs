...
export const english = Object.fromEntries([
  ...
  ['Encaixe peças e limpe linhas para carregar seu pulso.','Place pieces and clear lines to charge your pulse.'],['Carregando pulso','Charging pulse'],['Limpa 3 fileiras','Clears 3 rows'],['Pontos ×2 por 8s','Double points for 8s'],['Ativar pulso','Activate pulse'],['Exclusivo do Rush','Rush exclusive'],['Overdrive ativo','Overdrive active'],
  ...
  ['Cada peça carrega energia; linhas e combos dão um bônus. Ao atingir 100%, pressione F: o pulso remove até 3 fileiras ocupadas e dobra os pontos das linhas por 8 segundos.','Every piece charges energy; lines and combos add a bonus. At 100%, press F: the pulse removes up to 3 occupied rows and doubles line points for 8 seconds.'],
  ...
  ['Cinco novos amigos com poderes','Five new friends with powers'],['Nox, o morcego:','Nox the bat:'],['vira o tabuleiro de cabeça para baixo por 10s. Os movimentos laterais acompanham a tela.','flips the board upside down for 10s. Sideways controls follow the screen.'],['Turbo, o coelho:','Turbo the rabbit:'],['deixa a queda super-rápida por 10s!','makes pieces fall super fast for 10s!'],['Lino, o dragão:','Lino the dragon:'],['as próximas peças sorteadas são I por 10s. A reserva continua disponível.','the next pieces are all I pieces for 10s. Hold remains available.'],['Broca, a toupeira:','Broca the mole:'],['ao encaixar qualquer peça, destrói todos os blocos abaixo dela nas colunas que ela ocupa, por 10s. Cada bloco vale 25 pontos por nível.','for 10s, each landing piece destroys every block below it in the columns it occupies. Each block awards 25 points per level.'],['Sexto, o sapinho:','Sexto the frog:'],['por 15s, seis blocos em qualquer posição da mesma linha já bastam para limpá-la ao encaixar.','for 15s, six blocks anywhere in the same row are enough to clear it when a piece lands.'],['Os oito amigos aparecem em ordem embaralhada. Poderes diferentes podem se combinar; resgatar o mesmo amigo renova seu relógio. A pausa congela os efeitos.','All eight friends appear in shuffled order. Different powers can combine; rescuing the same friend refreshes its timer. Pausing freezes the effects.'],
  ...
  ['DO SEU JEITO','YOUR WAY'],['Ajuste seu flow.','Tune your flow.'],['Fechar configurações','Close settings'],['Música arcade','Arcade music'],['Três músicas em ordem aleatória.','Three tracks in shuffled order.'],['Volume da música','Music volume'],['Efeitos sonoros','Sound effects'],['Um som para cada boa jogada.','A sound for every great move.'],['Efeitos de movimento','Motion effects'],['Partículas, brilho, raios e fogos.','Particles, glow, lightning and fireworks.'],['Mostrar peça fantasma','Show ghost piece'],['Veja o encaixe antes de soltar.','See the landing before you drop.'],['Estas preferências ficam salvas neste dispositivo.','These preferences are saved on this device.'],['Pronto','Done'],
...
const templates = [
  ...
  ['{piece} surpresa','Surprise {piece}'],['{piece} · ativa ao encaixar','{piece} · activates on landing'],
