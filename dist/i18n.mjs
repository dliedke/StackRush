...
export const english = Object.fromEntries([
  ['Acerte 3 passarinhos','Hit 3 birds'],
  ['Resgate 2 bichinhos','Rescue 2 buddies'],
  ['Faça um combo de 3','Make a 3-piece combo'],
  ['Limpe 8 linhas','Clear 8 lines'],
  ['Encaixe 20 peças','Place 20 pieces'],
  ['Original','Original'],
  ['Aurora','Aurora'],
  ['Sem acessório','No accessory'],
  ['Coroa','Crown'],
  ['Estrelinhas','Little stars'],
  ['Chuva de corações','Heart shower'],
  ['Primeiro resgate','First rescue'],
  ['Sua jornada','Your journey'],
  ['MISSÕES','MISSIONS'],
  ['ÁLBUM DOS AMIGOS','BUDDY ALBUM'],
  ['Pequenas metas, pontos extras.','Small goals, extra points.'],
  ['Progresso das missões','Mission progress'],
  ['Resgate para colecionar','Rescue to collect'],
  ['Ver minha turma ↗','Meet my crew ↗'],
  ['SEU PRÓXIMO RECORDE','YOUR NEXT PERSONAL BEST'],
  ['Marque seu primeiro recorde!','Set your first personal best!'],
  ['Progresso para o recorde','Personal best progress'],
  ['Três chances de brilhar.','Three chances to shine.'],
  ['Cumpra as missões nesta partida e ganhe pontos extras.','Complete this game’s missions to earn extra points.'],
  ['MISSÕES DA PARTIDA','GAME MISSIONS'],
  ['UM OBJETIVO A CADA PARTIDA','A GOAL IN EVERY GAME'],
  ['Fechar missões','Close missions'],
  ['As missões recomeçam a cada partida. A recompensa entra na pontuação assim que você completa o objetivo.','Missions reset each game. The reward is added to your score as soon as you complete the goal.'],
  ['CADA RESGATE CONTA','EVERY RESCUE COUNTS'],
  ['Sua turma no flow.','Your crew in the flow.'],
  ['Fechar álbum','Close album'],
  ['Encontre os dez amigos! Resgate cada um 3 vezes para liberar a cor Aurora, 5 para a coroa e 10 para uma chuva de corações.','Find all ten friends! Rescue each one 3 times for the Aurora color, 5 for a crown, and 10 for a heart shower.'],
  ['Os novos visuais são equipados ao desbloquear. Você pode trocar abaixo de cada amigo. Seu álbum fica salvo neste dispositivo.','New looks are equipped when unlocked. You can change them below each friend. Your album is saved on this device.'],
  ['NOVO AMIGO!','NEW FRIEND!'],
  ['VISUAL LIBERADO!','LOOK UNLOCKED!'],
  ['MISSÃO CUMPRIDA!','MISSION COMPLETE!'],
  ['Concluída','Completed'],
  ['Ainda não encontrado','Not found yet'],
  ['Todos os visuais liberados!','All looks unlocked!'],
  ['Cor','Color'],
  ['Acessório','Accessory'],
  ['Comemoração','Celebration'],
  ['Complete 40 linhas e marque seu primeiro tempo!','Clear 40 lines to set your first time!'],
  ['RECORDE SUPERADO!','PERSONAL BEST BEATEN!'],
  ['Recorde empatado. Mais 1 ponto!','Personal best tied. Just 1 more point!'],
  ['TÁ QUASE!','ALMOST THERE!'],
  ['Complete as 40 linhas para bater seu tempo!','Clear all 40 lines to beat your time!'],
  ['Você superou seu recorde!','You beat your personal best!'],
  ['Seu próximo desafio começa na próxima partida.','Your next challenge starts with the next game.'],
  ['Seu álbum continua na próxima partida.','Keep building your album in the next game.'],
  ['Silenciar todo o áudio','Mute all audio'],['Ativar áudio','Unmute audio'],['silenciada','muted'],
  ['Foguetinho','Rocket'],
  ['FOGUETINHO','ROCKET'],
  ['🚀 Foguetinho','🚀 Rocket'],
  ['Vai, foguetinho! Abre caminho!','Go, rocket! Clear the way!'],
  ['Dispara ao encaixar e destrói tudo no caminho. Gire para escolher a direção!','Launches on landing and destroys everything in its path. Rotate to aim!'],
  ['Passarinhos acertados','Birds hit'],
  ['SEQUÊNCIA ×6','STREAK ×6'],
  ['Sequência de seis','Six-piece streak'],
  ['Passarinhos valem pontos','Birds award points'],
  ['Ao encaixar, o foguetinho dispara até a borda e destrói todos os blocos no caminho. Gire para apontar para baixo, para os lados ou para cima. Também acerta passarinhos e coleta bônus!','On landing, the rocket flies to the edge and destroys every block in its path. Rotate to aim down, sideways or up. It also hits birds and collects bonuses!'],
  ['De vez em quando, uma sequência especial traz seis peças iguais. O aviso mostra a peça sorteada e quantas ainda estão na fila. A reserva continua disponível; os presentes dos bichinhos vêm depois da sequência.','Every so often, a special streak brings six identical pieces. The notice shows the chosen piece and how many remain in the queue. Hold stays available; buddy gifts follow the streak.'],
  ['Passarinhos cruzam os espaços livres do tabuleiro. Acerte com uma peça, um poder ou um clique/toque: cada um vale 300 pontos por nível, em dobro no Overdrive.','Birds cross the empty spaces on the board. Hit them with a piece, a power or a click/tap: each awards 300 points per level, doubled during Overdrive.'],
  ...
  ['MIX SURPRESA','SURPRISE MIX'],['MIX CLÁSSICO','CLASSIC MIX'],['Raio. Prisma. Diagonal. Foguetinho!','Lightning. Prism. Diagonal. Rocket!'],['7 peças. Uma corrida contra o tempo.','7 pieces. A race against the clock.'],
  ...
  ['Encaixe peças e limpe linhas para carregar seu pulso.','Place pieces and clear lines to charge your pulse.'],['Carregando pulso','Charging pulse'],['Limpa 3 fileiras','Clears 3 rows'],['Pontos ×2 por 8s','Double points for 8s'],['Ativar pulso','Activate pulse'],['Auto burst','Auto burst'],['Auto burst (soltar sem parar)','Auto burst (non-stop drops)'],['AUTO BURST','AUTO BURST'],['LIGADO','ON'],['DESLIGADO','OFF'],['F PARA DESLIGAR','F TO TURN OFF'],['SOLTANDO SEM PARAR','DROPPING NON-STOP'],['Auto burst ligado.','Auto burst on.'],['Auto burst desligado.','Auto burst off.'],['AUTO','AUTO'],['Auto burst (F)','Auto burst (F)'],['Aumentar velocidade do auto burst','Increase auto burst speed'],['Reduzir velocidade do auto burst','Decrease auto burst speed'],['Velocidade do burst','Burst speed'],['Velocidade do auto burst','Auto burst speed'],['VELOCIDADE {speed} / {max}','SPEED {speed} / {max}'],['Ativar pulso do Overdrive','Activate the Overdrive pulse'],['Exclusivo do Rush','Rush exclusive'],['Overdrive ativo','Overdrive active'],
  ...
  ['Cada peça carrega energia; linhas e combos dão um bônus. Ao atingir 100%, pressione D: o pulso remove até 3 fileiras ocupadas e dobra os pontos das linhas por 8 segundos.','Every piece charges energy; lines and combos add a bonus. At 100%, press D: the pulse removes up to 3 occupied rows and doubles line points for 8 seconds.'],
  ['A peça contornada mostra onde sua peça vai cair. Você pode usar a reserva uma vez por peça. No Sprint 40, as sete peças são clássicas. Rush e Zen têm quatro formatos extras, bombas, quatro peças com poderes e bônus surpresa. No celular, arraste para os lados, toque na peça para girar e puxe para baixo para soltar de uma vez.','The outlined ghost shows where your piece will land. You can hold once per piece. Sprint 40 uses the seven classic pieces. Rush and Zen add four extra shapes, bombs, four power pieces and surprise bonuses. On mobile, drag sideways to move, tap to rotate, drag down a little and hold to soft drop, or drag farther down to hard drop.'],
  ['Surpresas no tabuleiro','Board surprises'],['Peças especiais: Mini, Dupla, Cantinho, Ferradura, Bomba, Raio, Prisma, Diagonal e Foguetinho','Special pieces: Mini, Duo, Corner, Horseshoe, Bomb, Lightning, Prism, Diagonal and Rocket'],['Peças extras: Mini (1 bloco), Dupla (2), Cantinho (3) e Ferradura (5). Aperte A para girar 180° de uma vez.','Extra pieces: Mini (1 block), Duo (2), Corner (3) and Horseshoe (5). Press A to rotate 180 degrees.'],
...
const templates = [
  ['{name} entrou para o álbum!','{name} joined the album!'],
  ['{count} / {total} amigos','{count} / {total} friends'],
  ['{count} resgates no álbum','{count} album rescues'],
  ['{count} resgates','{count} rescues'],
  ['{count} / {total} resgates','{count} / {total} rescues'],
  ['Progresso de {name}','{name} progress'],
  ['Cor de {name}','Color for {name}'],['Acessório de {name}','Accessory for {name}'],['Comemoração de {name}','Celebration for {name}'],
  ['Seu melhor tempo: {time}','Your best time: {time}'],
  ['Faltam {score} pontos para o recorde!','{score} points to your personal best!'],
  ['{count} / {total} missões','{count} / {total} missions'],
  ['{count} visuais liberados nesta partida!','{count} looks unlocked this game!'],
  ['{count} resgates para {style}','{count} rescues to unlock {style}'],
  ['Passarinho! {score} pontos','Bird! {score} points'],['6 peças {piece} seguidas!','6 {piece} pieces in a row!'],['{count} na fila','{count} queued'],
